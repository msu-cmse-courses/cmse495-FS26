...
- <https://gitlab.msu.edu/CMSE/SCHOLAR>
...
{% include mini-schedule.html keyword="SCHOLAR" title="SCHOLAR Timeline" %}
...
Please review the course [Git resources](Git Repository Organization] and [Dirk's Rules for Repositories](https://colbrydi.github.io/Research_guidelines/Rules_for_Repos.html) before submitting contributions.
...
<li><a href="#friday-scholar-work">Friday SCHOLAR Work</a></li>
<li><a href="#reviewing-existing-tutorials">Reviewing Existing Tutorials</a></li>
<li><a href="#gitlab-issues">GitLab Issues</a></li>
<li><a href="#pull-requests">Pull Requests</a></li>
<li><a href="#quality-expectations">Quality Expectations</a></li>
<li><a href="#earning-credit">Earning Credit</a></li>
