...
| Parings V1 | Team A | Team B | Team C | Team D |
    |--------|--------|--------|--------|--------|
    | 1 | CustomersLens | ToolsForHumanity | TeliAI | BW-Water_Leaks |
    | 2 | CEPI | UofM | Joyntly | MSU-Curriculum |
    | 3 | Delta_Dental | NCEAS | BW-Design | Luce |
    | 4 | WBPD | Kellanova | HFH-VS | MSU-SW_Lansing |
